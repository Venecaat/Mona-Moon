    ...
    return (
        <div className="text-xl font-semibold">
            <div className="grid grid-cols-1 mb-6 text-center md:text-left text-2xl gap-7">
                <NormalParagraph text="Gyerekkorom óta érdekelnek a különböző táncok,
                ...
                />
                <NormalParagraph text="A hastáncot 2005 januárjában kezdtem el, és azóta az életem egyik legfontosabb részévé vált.
                    Ezt a nőies táncműfajt Dina Jamilah ismertette meg velem az 1001 Éjszaka Hastánc Stúdióban."
                />
                <NormalParagraph text="Akkoriban sok hazai versenyen vettem részt szólóban és Dina versenyző csapatának tagjaként.
                ...
                <NormalParagraph text="2008-tól kezdődően 3,5 éven keresztül tanítottam Dina tánciskolájában,
                ...
                />
                <NormalParagraph text="2016-tól a tanítványaimnak is elkezdtem fellépő koreográfiákat készíteni, és fellépéseket vállalni.
                    Velük azóta is a Mona Moon és az Ezüst Csillagok néven működünk."
                />
                <NormalParagraph text="2019 tavaszától, a kislányom születése után fél évig nem tartottam órát,
